    ...
    public class AdvanceImage : LinkBase
    {
        ...
        protected override void DoRender(HtmlTextWriter output)
        {
            ...
            var html = System.IO.File.ReadAllText(path)
                ...
                .Replace("{CROP_FOCUS}", string.Format("{0},{1},{2},{3},{4},{5},{6},{7}",
                    XmlValue.GetAttribute("cropx"),
                    XmlValue.GetAttribute("cropy"),
                    XmlValue.GetAttribute("focusx"),
                    XmlValue.GetAttribute("focusy"),
                    XmlValue.GetAttribute("cropxm"),
                    XmlValue.GetAttribute("cropym"),
                    XmlValue.GetAttribute("focusxm"),
                    XmlValue.GetAttribute("focusym")));
            ...
            if (message["id"] == this.ID)
            {
                ...
                if (name != null)
                {
                    ...
                    if (str == "contentimage:crop" && !string.IsNullOrEmpty(message["cx"]) && !string.IsNullOrEmpty(message["cy"]))
                    {
                        ...
                        this.XmlValue.SetAttribute("cropxm", message["cxm"]);
                        this.XmlValue.SetAttribute("cropym", message["cym"]);
                        this.XmlValue.SetAttribute("focusxm", message["fxm"]);
                        this.XmlValue.SetAttribute("focusym", message["fym"]);
                    }
